...
class BusinessSettingsController extends Controller
{
  ...
  // Third Party Delivery Settings
        BusinessSetting::updateOrInsert(['key' => 'third_party_delivery_status'], [
            'value' => $request['third_party_delivery_status'] ?? 0
        ]);
        ...
        $thirdPartyDeliveryConfig = [
            ...
            'utc_offset' => $request['utc_offset'] ?? 330
        ];
        ...
        // Adloggs Config
        $adloggsConfig = [
            'api_key' => $request['adloggs_api_key'] ?? '',
            'base_url' => $request['adloggs_base_url'] ?? 'https://dev.adloggs.com',
            'partner_merchant_id' => $request['adloggs_partner_merchant_id'] ?? '5421'
        ];
