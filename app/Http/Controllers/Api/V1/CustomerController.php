    ...
    public function update_address(Request $request, $id)
{
    ...
    // Retrieve updated address data
    $updatedAddress = DB::table('customer_addresses')->find($id);

    return response()->json([
        'message' => translate('messages.updated_successfully'),
        'zone_id' => $zone->id,
        'address' => $updatedAddress // Return updated address data
    ], 200);
}
