    ...
    public function get_item_campaigns(Request $request)
{
    ...
    try {
        ...
        // Add delivery_time for each campaign
        foreach ($campaigns as &$campaign) {
            // Assuming the campaign has a relation 'restaurant' to fetch the delivery time
            $restaurant = $campaign->restaurant; // This should be eager loaded in your model if needed
            $campaign['delivery_time'] = $restaurant ? $restaurant->delivery_time : null;
        }
