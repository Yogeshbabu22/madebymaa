...
// use App\Http\Controllers\Api\V1\Vendor\CustomerAuthController;
use App\Http\Controllers\GeolocationController;
use App\Http\Controllers\Api\V1\WebHookController;
use App\Http\Controllers\Api\V1\AdloggsWebhookController;
...
Route::get('/geolocation', 'GeolocationController@getGeolocation');
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('request-otp','CustomerAuthController@requestOtp');
    // Verify OTP and login
        Route::post('login-otp', 'CustomerAuthController@verify_Login_Otp');
        
         Route::post('photo-upload','CustomerAuthController@uploadPhoto');
        ...
        Route::group(['prefix' => 'booking'], function () {
            Route::post('create', 'CustomerAuthController@store');   // Create a new booking
            Route::get('list', 'CustomerAuthController@index');     // List all bookings
            Route::get('details/{id}', 'CustomerAuthController@show');   // Get details of a specific booking
            Route::put('update/{id}', 'CustomerAuthController@update'); // Update a booking
            Route::delete('delete/{id}', 'CustomerAuthController@destroy'); // Delete a booking
        });

          Route::group(['prefix' => 'items'], function () {
            Route::post('create', 'CustomerAuthController@store_item');   // Create a new booking
            Route::get('list', 'CustomerAuthController@list_item');     // List all bookings
            Route::get('details/{id}', 'CustomerAuthController@show_item');   // Get details of a specific booking
            Route::put('update/{id}', 'CustomerAuthController@update_item'); // Update a booking
            Route::delete('delete/{id}', 'CustomerAuthController@destroy_item'); // Delete a booking
        });
        ...
        Route::group(['prefix' => 'vendor'], function () {
              Route::post('send-otp','VendorLoginController@sendVendorOtp');
            Route::post('verify-otp', 'VendorLoginController@verifyVendorOtp');
            ...
            Route::post('restaurant-pending-list','VendorLoginController@restaurant_pending_lists');
            Route::post('restaurant-confirm-check','VendorLoginController@restaurant_confirm_check');
        //subscription
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::put('update-order-statuses', 'VendorController@update_order_statuses');
        ...
        Route::get('get-products-lists', 'VendorController@get_productss');
        ...
        Route::get('get-withdraw-method-list', 'VendorController@withdraw_method_list');
         ...
         //Instant
        Route::post('/createOrder','FoodController@createOrder');
        Route::get('/{vendor_id}/{food_id}', 'FoodController@showOrder');
        Route::post('/orders/{food_id}', 'FoodController@updateOrder');
        // Route::delete('/{vendor_id}/{food_id}', 'FoodController@destroyOrder');
        ...
        Route::get('availability', 'BusinessSettingsController@get_availability');
        Route::post('availability', 'BusinessSettingsController@update_availability');
        ...
        // Route::group(['prefix' => 'booking'], function () {
        //     Route::post('create', 'CustomerAuthController@store');   // Create a new booking
        //     Route::get('list', 'CustomerAuthController@list');     // List all bookings
        //     Route::get('details', 'CustomerAuthController@show');   // Get details of a specific booking
        //     Route::put('update/{id}', 'CustomerAuthController@update'); // Update a booking
        //     Route::delete('delete/{id}', 'CustomerAuthController@destroy'); // Delete a booking
        // });
        ...
        Route::group(['prefix'=>'product'], function(){
            ...
            Route::post('updates/{id}', 'FoodController@updates');
            ...
            Route::post('food-schedule', 'FoodController@addSchedule');
            Route::post('update-food-schedule', 'FoodController@updateSchedule');
            Route::get('schedule/{food_id}', 'FoodController@listSchedule');
 ...
 Route::get('restaurants/available-in-radius', 'RestaurantController@restro_available_in_radius');
    ...
    Route::group(['prefix' => 'cuisine'], function () {
        ...
        Route::get('get_restaurants_by_cuisine', 'CuisineController@get_restaurants_by_filter_cuisine');
        
    });

    // Super Category (MainCategory) endpoint
    Route::get('getSuperCategory', 'MainCategoryController@getSuperCategory');
    Route::get('getFoodBySuperCategory', 'MainCategoryController@getFoodBySuperCategory');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
        Route::group(['prefix' => 'order'], function () {
            ...
            //  Route::get('food-available-times/{food_id}', 'OrderController@get_food_available_times');
             Route::get('available-times/{food_id}', 'OrderController@getAvailableTimes');
...
// Route::post('/webhook/adloggs', [AdloggsWebhookController::class, 'webhook']);
 Route::post('/webhook/adloggs', [AdloggsWebhookController::class, 'handle']);
...
Route::post('/delivery-webhook',[WebHookController::class ,'handleWebHook']);
