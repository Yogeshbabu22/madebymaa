    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.','middleware'=>['module:restaurant']], function () {
            ...
            Route::group(['middleware' => ['module:restaurant']], function () {
                ...
                Route::get('approved/list', 'VendorController@approved')->name('approved');
                Route::get('denied/list', 'VendorController@denied')->name('denied');
                Route::get('status_change/{id}/{status}', 'VendorController@status_change')->name('status_change');
        ...
        Route::group(['prefix' => 'main-category', 'as' => 'main-category.'], function () {
            Route::group(['middleware' => ['module:category']], function () {
                Route::get('add', 'MainCategoryController@index')->name('add');
                ...
                Route::get('update-priority/{mainCategory}', 'MainCategoryController@update_priority')->name('priority');
                Route::get('status/{id}/{status}', 'MainCategoryController@status')->name('status');
                Route::delete('delete/{id}', 'MainCategoryController@delete')->name('delete');
            });
        });
