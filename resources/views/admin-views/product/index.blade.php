                            ...
                            <tr data-category-id="{{ $mainCategory->id }}" data-category-name="{{ strtolower($mainCategory->name) }}">
                                ...
                                @foreach($days as $day)
                                    <td class="text-center">
                                        <label class="toggle-switch toggle-switch-sm" for="toggle_{{ $mainCategory->id }}_{{ strtolower($day) }}">
                                            <input type="checkbox"
                                                   class="toggle-switch-input availability-toggle"
                                                   id="toggle_{{ $mainCategory->id }}_{{ strtolower($day) }}"
                                                   data-category-id="{{ $mainCategory->id }}"
                                                   data-category-name="{{ strtolower($mainCategory->name) }}"
