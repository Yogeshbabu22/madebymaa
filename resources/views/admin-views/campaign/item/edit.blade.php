                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <div class="lang_form" id="default-form">
                                        ...
                                        <div class="form-group mb-0">
            <label class="input-label" for="ingredients">{{translate('messages.ingredients')}} ({{translate('Default')}})</label>
            <input type="text" name="ingredients" class="form-control" placeholder="{{translate('messages.enter_ingredients')}}" value="{{ $campaign->getRawOriginal('ingredients') }}">
