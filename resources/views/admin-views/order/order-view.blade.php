            ...
            <div class="col-lg-4 order-print-area-right">
                ...
                <div class="row g-1">
                                                                ...
                                                                @endif
                                                                    ...
                                                                    <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton">
                                                                        ...
                                                                        <a class="dropdown-item route-alert {{ $order['order_status'] == 'handover' ? 'active' : '' }}"
                                                                            ...
                                                                            href="javascript:" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">{{ translate('messages.handover') }}</a>
                                                                        <a class="dropdown-item route-alert {{ $order['order_status'] == 'picked_up' ? 'active' : '' }}"
                                                                            ...
                                                                            href="javascript:" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">{{ translate('messages.out_for_delivery') }}</a>
                                                                        <a class="dropdown-item route-alert {{ $order['order_status'] == 'delivered' ? 'active' : '' }}"
                                                                            ...
                                                                            href="javascript:" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">{{ translate('messages.delivered') }}</a>
                            ...
                            @endif
                                ...
                                @if($order->delivery_partner == 'adloggs')
                                <div class="col-12">
                                        ...
                                        <div class="card-body pt-2">
                                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                                <h5 class="card-title text-primary">
                                                    ...
                                                    <span>
                                                        {{translate('Third Party Delivery')}} (Adloggs)
                                                    </span>
                                                </h5>
                                                <span class="badge badge-soft-primary">
                                                    {{translate('Active')}}
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    <strong class="text--title d-block mb-1">{{translate('Delivery Status')}}:</strong>
                                                    <span class="badge badge-soft-info">
                                                        {{ $order->delivery_status ?? 'N/A' }}
                                                    </span>
                                                </div>
                                                @if($order->adloggs_order_uuid)
                                                <div class="col-md-6">
                                                    <strong class="text--title d-block mb-1">{{translate('Adloggs Order UUID')}}:</strong>
                                                    <span class="text--title">{{ $order->adloggs_order_uuid }}</span>
                                                </div>
                                                @endif
                                                @if($order->delivery_tracking_url)
                                                <div class="col-md-12">
                                                    <strong class="text--title d-block mb-1">{{translate('Tracking URL')}}:</strong>
                                                    <a href="{{ $order->delivery_tracking_url }}" target="_blank" class="text-primary">
                                                        <i class="tio-open-in-new"></i> {{translate('View Tracking')}}
                                                    </a>
                                                </div>
                                                @endif
                                                @if($order->delivery_agent_name)
                                                <div class="col-md-6">
                                                    <strong class="text--title d-block mb-1">{{translate('Delivery Agent')}}:</strong>
                                                    <span class="text--title">{{ $order->delivery_agent_name }}</span>
                                                </div>
                                                @endif
                                                @if($order->delivery_agent_phone)
                                                <div class="col-md-6">
                                                    <strong class="text--title d-block mb-1">{{translate('Agent Phone')}}:</strong>
                                                    <span class="text--title">{{ $order->delivery_agent_phone }}</span>
                                                </div>
                                                @endif
                                                @if($order->delivery_fee)
                                                <div class="col-md-6">
                                                    <strong class="text--title d-block mb-1">{{translate('Delivery Fee')}}:</strong>
                                                    <span class="text--title">{{ Helpers::format_currency($order->delivery_fee) }}</span>
                                                </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="alert alert-warning mt-3 mb-0">
                                                ...
                                                {{translate('Order not yet created on Adloggs. Check logs for details.')}}
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body pt-2">
                                            ...
                                            <div class="w-100 text-right initial-39-4">
                                                ...
                                                <div class="media-body">
                                                    <strong class="d-block text--title">
                                                        {{ $order->delivery_men_name }}
                                                    </strong>

                                                    <span class="text--title font-semibold d-block">
                                                        <i class="tio-call-talking-quiet"></i> {{ $order->delivery_men_phone }}
                                                    </span>
                                            ...
                                            @if (isset($order))
                                                <span class="d-block">
                                                    <a target="_blank"
                                                        href="http://maps.google.com/maps?z=12&t=m&q=loc:{{ $order->delivery_men_current_lat }}+{{ $order->delivery_men_current_long }}">
                                                        <i class="tio-poi"></i>(Tap on blue pin to fetch current location of delivery boy)<br>
                                                    </a>
                                                </span>
                                            @else
