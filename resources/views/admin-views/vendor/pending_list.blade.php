        ...
        <div class="d-flex flex-wrap mb-4 __gap-15px">
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.restaurant.approved')}}"  aria-disabled="true">{{translate('Approved List')}}</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row gx-2 gx-lg-3 mt-3" >
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h3 class="card-title">{{translate('messages.restaurants_list')}}
                                <span class="badge badge-soft-dark ml-2" id="itemCount">{{\App\Models\RestaurantPendingList::where("status","=","pending")->where("confirm_status",0)->count();}}</span>
                            </h3>
                    ...
                    <!-- Table -->
                    <div class="table-responsive datatable-custom resturant-pending-list-table">
                           <table id="columnSearchDatatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                               ...
                               <tbody id="set-rows">
                                    <?php $sno = 1;?>
                                    @if(isset($restaurant_penings) && count($restaurant_penings) > 0)
                                        @foreach($restaurant_penings as $val)
                                            <tr>
                                                  <td>
                                          {{$sno++;}}
                                    </td>
                           ...
                           <?php
                            $pending_lists = \App\Models\RestaurantPendingList::where('confirm_status',0)->get();
                            ?>
                           @if(count($pending_lists) === 0)
