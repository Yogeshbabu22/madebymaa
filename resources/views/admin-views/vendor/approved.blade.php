...
@section('title',translate('Approved Lists'))
...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> {{ translate('Approved Restaurant List')}} </h1>
            <!-- Resturent List -->
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.restaurant.approved')}}"  >{{translate('Approved List')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('admin.restaurant.denied')}}"  >{{translate('messages.Rejected_Request')}}</a>
                    </li>
                    ...
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h3 class="card-title">{{translate('messages.restaurants_list')}}
                                <span class="badge badge-soft-dark ml-2" id="itemCount">{{\App\Models\RestaurantPendingList::where("status","=","approved")
                                ->where("confirm_status",1)->where("register_status",0)->count();}}</span>
                            </h3>
