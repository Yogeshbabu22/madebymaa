        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="zone_form" class="shadow--card">
                    ...
                    <label class="input-label" for="zone_radius">{{ translate('Zone Radius (km)') }}</label>
                    <input type="number" name="radius" id="zone_radius" class="form-control" placeholder="{{translate('Enter radius in kilometers')}}" min="1" step="0.1" required>
                    <small class="text-muted">{{ translate('Define the radius within which the zone applies') }}</small>
                </div>
