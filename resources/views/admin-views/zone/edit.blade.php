...
@section('content')
    ...
    <label class="input-label" for="radius">{{ translate('messages.Radius') }} (in km)</label>
    <input type="number" id="radius" name="radius" class="form-control" placeholder="{{ translate('messages.Enter_radius') }}" min="1" step="0.1" value="{{ old('radius', $zone->radius ?? '') }}">
</div>
