            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <!-- End Restaurant -->
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('category'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/category*') || Request::is('admin/main-category*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/category*') || Request::is('admin/main-category*') ? 'block' : 'none' }}">


                                <li class="nav-item {{ Request::is('admin/main-category*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.main-category.add') }}"
