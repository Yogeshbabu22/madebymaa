...
<head>
    ...
    <title>MadeByMaa Admin Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="dashboard-container">
        ...
        <div class="left-panel">
            ...
            <div class="login-buttons">
                ...
                <a href="https://deshboard.madebymaa.store/employee/login" class="login-btn">
                    Employee Login
                </a>
                <a href="https://jibble.com" class="login-btn jibble-btn" target="_blank">
                    Jibble.com
                </a>
            </div>
